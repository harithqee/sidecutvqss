<div class="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]"
     x-data="{
        ...
        async fetchQueueCount() {
            ...
            this.currentlyInQueue = Math.min(tickets.length, this.maxCapacity);
            this.updateChart();
        },

        startPolling() {
            this.intervalId = setInterval(() => {
                if (this.isLive) this.fetchQueueCount();
            }, 10000);
        },
                ...
                responsive: [
                    {
                        ...
                        options: {
                            chart: { height: 260 },
                            plotOptions: { radialBar: { dataLabels: { value: { fontSize: '24px', offsetY: -26 } } } },
                        },
                    },
                ],
            };
    ...
    <div class="shadow-default rounded-2xl bg-white px-4 pb-8 pt-5 dark:bg-gray-900 sm:px-6 sm:pb-11 sm:pt-6">
        ...
        <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-theme-xs text-gray-500 transition-opacity duration-300 sm:text-sm" x-text="statusMessage"></p>
    </div>

    <div class="flex flex-wrap items-center justify-center gap-4 px-4 py-3.5 sm:gap-8 sm:px-6 sm:py-5">
        <div class="min-w-[70px]">
            <p class="mb-1 text-center text-theme-xs text-gray-500 dark:text-gray-400 sm:text-sm">Max Capacity</p>
        ...
        <div class="min-w-[70px]">
            ...
            <p class="flex items-center justify-center gap-1 text-sm font-semibold text-gray-800 dark:text-white/90 sm:text-lg">
                ...
                <svg x-show="currentlyInQueue > maxCapacity * 0.6" width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
        ...
        <div class="min-w-[70px]">
            <p class="mb-1 text-center text-theme-xs text-gray-500 dark:text-gray-400 sm:text-sm">Utilization</p>
            <p class="flex items-center justify-center gap-1 text-sm font-semibold text-gray-800 dark:text-white/90 sm:text-lg">
